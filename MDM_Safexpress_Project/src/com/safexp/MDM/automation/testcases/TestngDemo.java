...
public class TestngDemo {
	...
	public void hybridTestAutomation(String s1, String s2)
	{
		UtilityClass.logger=UtilityClass.extent.createTest(s2);
	   	HybridFrameworkDriver.hybridTestAutomation(s1, s2,"TestData/ModuleLogin.xls");
...
@DataProvider
	...
	record=conn.executeQuery("select TestCaseID,TestCaseName from DriverSheet where ExecutionMode='y'");
